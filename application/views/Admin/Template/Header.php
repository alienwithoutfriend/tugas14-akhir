...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <title>Dashboard Ecommerce | Remark Admin Template</title>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/examples/css/dashboard/ecommerce.css') ?>">
    ...
    <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
      ...
      <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
          ...
          <span class="navbar-brand-text hidden-xs-down"> Inventory</span>
        </div>
        ...
        <div>
          <div>
            <ul class="site-menu" data-plugin="menu">
              ...
              <li class="site-menu-item has-sub">
                  <?php if ($this->uri->segment(1) === 'kelola-barang'):
                      $active = 'active';
                  else: 
                      $active = '';
                  endif; ?>
                  ...
                  <li class="site-menu-item <?= $active ?>">
                    <a class="animsition-link" href="<?= base_url('kelola-barang')?>">
                            <i class="site-menu-icon wb-shopping-cart" aria-hidden="true"></i>
                            <span class="site-menu-title">Barang</span>
                        </a>
                  </li>

                  <?php if ($this->uri->segment(1) === 'kelola-kategori'):
                      $active = 'active';
                  else: 
                      $active = '';
                  endif; ?>
                  ...
                  <li class="site-menu-item <?= $active ?>">
                    <a class="animsition-link" href="<?= base_url('kelola-kategori')?>">
                            <i class="site-menu-icon wb-order" aria-hidden="true"></i>
                            <span class="site-menu-title">Kategori</span>
                        </a>
                  </li>

                  <?php if ($this->uri->segment(1) === 'kelola-gudang'):
                      $active = 'active';
                  else: 
                      $active = '';
                  endif; ?>
                  ...
                  <li class="site-menu-item <?= $active ?>">
                    <a class="animsition-link" href="<?= base_url('kelola-gudang')?>">
              ...
              <li class="site-menu-category">Kelola Inventory</li>
              <li class="site-menu-item has-sub">
                  <?php if ($this->uri->segment(1) === 'barang-masuk'):
                      $active = 'active';
                  else: 
                      $active = '';
                  endif; ?>
                  ...
                  <li class="site-menu-item <?= $active ?>">
                    <a class="animsition-link" href="<?= base_url('kelola-permintaan')?>">
                            <i class="site-menu-icon wb-upload" aria-hidden="true"></i>
                            <span class="site-menu-title">Mutasi Barang</span>
                        </a>
                  </li>

                  <?php if ($this->uri->segment(1) === 'kelola-opname'):
                      $active = 'active';
                  else: 
                      $active = '';
                  endif; ?>
                  ...
                  <li class="site-menu-item <?= $active ?>">
                    <a class="animsition-link" href="<?= base_url('kelola-opname')?>">
